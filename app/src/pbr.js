var createPBRTestScene = function () {
    ...
    var camera =
        //new BABYLON.TouchCamera("TouchCamera", new BABYLON.Vector3(0, 0, -150), scene);
        new BABYLON.ArcRotateCamera("Camera", -Math.PI / 4, Math.PI / 2.5, 200, BABYLON.Vector3.Zero(), scene);
